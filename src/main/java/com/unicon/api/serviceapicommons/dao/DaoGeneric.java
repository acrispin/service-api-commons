package com.unicon.api.serviceapicommons.dao;
...
import com.unicon.api.serviceapicommons.dao.enums.EConnectionType;
...
public abstract class DaoGeneric<U> {
     ...
     * @return SqlSessionFactory
     */
    protected abstract SqlSessionFactory getSqlSessionFactorySdc(String idMarca);

    /**
     * @return SqlSessionFactory
     */
    protected abstract SqlSessionFactory getSqlSessionFactoryCmd(String idMarca);
    ...
    protected SqlSessionFactory getSqlSessionFactoryGeneral() {
        switch (getConnectionType()) {
            case SINGLE:
                return getSqlSessionFactory();
            case SDC:
                return getSqlSessionFactorySdc(getIdMarca());
            case CMD:
                return getSqlSessionFactoryCmd(getIdMarca());
        }
        return getSqlSessionFactory();
    }
    ...
    protected <T> List<T> queryList(String methodName, Object... params) {
        ...
        try (SqlSession session = getSqlSessionFactoryGeneral().openSession(true)) {
    ...
    protected <T, V> V executeDml(String methodName,
                                  Class<?> paramClass, T param) {
        try (SqlSession session = getSqlSessionFactoryGeneral().openSession(false)) {
