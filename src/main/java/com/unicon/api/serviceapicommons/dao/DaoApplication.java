...
public abstract class DaoApplication<T, U> extends DaoBase<T, U> {
    ...
    @Override
    public synchronized SqlSessionFactory getSqlSessionFactorySdc(String idMarca) {
    ...
    @Override
    public synchronized SqlSessionFactory getSqlSessionFactoryCmd(String idMarca) {
    ...
    public static synchronized SqlSessionFactory getSqlSessionFactory2() {
        if (sqlSessionFactory == null) {
            sqlSessionFactory  = init();
        }
        return sqlSessionFactory;
    ...
    public static synchronized SqlSessionFactory getSqlSessionFactorySdc2(String idMarca) {
        if (!SQL_SESSION_FACTORY_MAP_SDC.containsKey(idMarca)) {
            SQL_SESSION_FACTORY_MAP_SDC.put(idMarca, init(idMarca, "sdc"));
        }
        return SQL_SESSION_FACTORY_MAP_SDC.get(idMarca);
    ...
    public static synchronized SqlSessionFactory getSqlSessionFactoryCmd2(String idMarca) {
        if (!SQL_SESSION_FACTORY_MAP_CMD.containsKey(idMarca)) {
            SQL_SESSION_FACTORY_MAP_CMD.put(idMarca, init(idMarca, "cmd"));
        }
        return SQL_SESSION_FACTORY_MAP_CMD.get(idMarca);
